...
public class CropImageActivity extends AppCompatActivity
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        if (item.getItemId() == R.id.crop_image_menu_crop) {
            if (mCropImageView.hasBeenCropped() || !mOptions.cropIsMandatory)
                cropImage();
            else {
                showDialogCropIsMandatory();
            }
            return true;
        }
    ...
    private void showDialogCropIsMandatory() {
        AlertDialog dialogMandatory = new AlertDialog.Builder(this, android.support.v7.appcompat.R.style.Theme_AppCompat_Light_Dialog_Alert)
                .setMessage(mOptions.cropIsMandatoryMsg)
                .setCancelable(false)
                .setPositiveButton("OK", (dialog, which) -> dialog.dismiss())
                .create();
        dialogMandatory.requestWindowFeature(Window.FEATURE_NO_TITLE);
        dialogMandatory.show();
    }
