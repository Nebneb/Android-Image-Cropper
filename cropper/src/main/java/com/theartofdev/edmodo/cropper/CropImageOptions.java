...
public class CropImageOptions implements Parcelable {
    ...
    /* optional image resource to be used for crop menu crop icon instead of text */
    public String cropIsMandatoryMsg;

    /**
     * optional, don't validate if crop is mandatory
     **/
    public boolean cropIsMandatory;
    ...
    public CropImageOptions() {
        ...
        cropIsMandatory = false;
        cropIsMandatoryMsg = null;
    }
    ...
    protected CropImageOptions(Parcel in) {
        ...
        cropIsMandatory = in.readByte() != 0;
        cropIsMandatoryMsg = in.readString();
    }
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeByte((byte) (cropIsMandatory ? 1 : 0));
        dest.writeString(cropIsMandatoryMsg);
    }
